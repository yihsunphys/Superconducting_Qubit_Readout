...
if __name__ == '__main__':
    Demo = 0
    filepath = r"C:\Users\SQC\Desktop\ZCU\ZCU_Data\Test075\2024\06\Data_0623\Test075_TwoTone_flux_001.hdf5"
    filepaths = [
        # r'C:\Users\SQC\Desktop\ZCU\ZCU_Data\Test045[02]\2024\05\Data_0526\Test045_OneTone_flux_002.hdf5'
    ]
    if Demo:
        simulation = fit_spectrum(
            [4.85, 0.8, 1.088], # EJ, EC, EL
        ...
        fitting2 = fit_spectrum(
            [9.63, 0.754, 1.47], # EJ, EC, EL
            [-150, -2220, 2071], #zero phi current (uA), half phi current(uA), points
        ...
        # # fitting2.spectrum.update_layout(yaxis_range = [4, 6.5])
        # fitting2.spectrum.update_layout(xaxis_range = [-3.69, 0.28])
